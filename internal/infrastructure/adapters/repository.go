...
func (it *SQLManager) CreateUserSQL(info entity.User) error {
...
func (it *SQLManager) LoginUserSQL(userEmail string) (entity.User, error) {
...
func (it *SQLManager) GetUserByEmail(email string) (entity.User, error) {
...
func (it *SQLManager) GetMyInfoSQL(infoID string) (entity.User, error) {
	query := `SELECT id,
		name, 
		email, 
		password_hash, 
